...
def getData(n, th=60, min3=0.8, min2=0.7, min1=-0.6):
    ...
    print_CO_attainment(1, smaller_df['CO1 (37)'], smaller_df['CO1_ES'], th, th)
    print_CO_attainment(2, smaller_df['CO2 (46)'], smaller_df['CO2_ES'], th, th)
    print_CO_attainment(3, smaller_df['CO3 (37)'], smaller_df['CO3_ES'], th, th)
    print_CO_attainment(4, smaller_df['CO4 (25).1'], smaller_df['CO4_ES'], th, th)
    print_CO_attainment(5, smaller_df['CO5 (25).1'], smaller_df['CO5_ES'], th, th)
